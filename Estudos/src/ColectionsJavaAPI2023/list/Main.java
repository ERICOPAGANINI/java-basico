...
public class Main {
	...
	public static void main(String[] args) {
		 ...
		 * System.out.println("O numero total de elementos na lista e: " +
		 ...
		 * System.out.println("O numero total de elementos na lista e: " +
		 * listaTarefa.obterNumeroTotalDeTarefas());
		 * System.out.println("---------------"); listaTarefa.removerTarefa("Tarefa 2");
		 * System.out.println("O numero total de elementos na lista e: " +
		 * listaTarefa.obterNumeroTotalDeTarefas());
		 * listaTarefa.obterDescricoesTarefas(); System.out.println("---------------");
		 * listaTarefa.removerTarefa("tarefa 5"); listaTarefa.removerTarefa("TAREFA 4");
		 * System.out.println("O numero total de elementos na lista e: " +
		 * listaTarefa.obterNumeroTotalDeTarefas());
		 * listaTarefa.obterDescricoesTarefas(); System.out.println(
		 * "--------------------------------------------------------------------");
		 ...
		 * "Susan J. Fowler", 2017);
		 * catalogoLivros.adicionarLivro("Java Guia do Programador",
		 * "Peter Jandl Junior", 2021);
		 * catalogoLivros.adicionarLivro("Java Guia do Programador",
		 * "Peter Jandl Junior", 2021); catalogoLivros.adicionarLivro("Código Limpo",
		 * "Robert C. Martin", 2009);
		 * catalogoLivros.adicionarLivro("O Codificador Limpo", "Robert C. Martin",
		 * 2012);
